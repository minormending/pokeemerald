const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_LEAFLING] = {{EVO_LEVEL, 22, SPECIES_LEAFLIN2}},
    [SPECIES_FLARION] = {{EVO_LEVEL, 36, SPECIES_CHARIZARD}},
    [SPECIES_CINDERPUP] = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ARCANINE}},
};
