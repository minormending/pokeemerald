const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(FLARION, gMonFrontPic_Charizard),
    SPECIES_SPRITE(AZURUNE, gMonFrontPic_Latias),
    SPECIES_SPRITE(TERRAPYON, gMonFrontPic_Aggron),
    SPECIES_SPRITE(LEAFLING, gMonFrontPic_Roselia),
    SPECIES_SPRITE(LEAFLIN2, gMonFrontPic_Vileplume),
    SPECIES_SPRITE(CINDERPUP, gMonFrontPic_Growlithe),
};
